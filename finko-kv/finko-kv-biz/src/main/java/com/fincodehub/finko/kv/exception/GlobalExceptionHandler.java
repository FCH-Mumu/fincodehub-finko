package com.fincodehub.finko.kv.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseObject<Object> handleMethodArgumentNotValidException(HttpServletRequest request, Exception e){
        // 参数错误异常码
