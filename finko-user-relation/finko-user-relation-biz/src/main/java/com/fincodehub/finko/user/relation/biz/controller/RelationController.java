...
public class RelationController {
    ...
    public ResponseObject<?> follow(@Validated @RequestBody FollowUserReqVO followUserReqVO) {
        return relationService.follow(followUserReqVO);
    }
    @PostMapping("/unfollow")
    @ApiOperationLog(description = "取关用户")
    public ResponseObject<?> unfollow(@Validated @RequestBody UnfollowUserReqVO unfollowUserReqVO) {
