package com.fincodehub.finko.user.biz.exception;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseObject<Object> handleException(HttpServletRequest request, MethodArgumentNotValidException e) {
        // 参数错误异常码
